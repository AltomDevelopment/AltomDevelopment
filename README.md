...
- **ExampleProject** :page_facing_up: [View Flowbite Admin Dashboard](https://github.com/AltomDevelopment/Everything-You-Need-For-React-/tree/main/Project%20Setup/ExampleProject/AdminDashboardTailwindTemplateApp)
- **React_Hooks** :page_facing_up: [React Hook Cheat Sheet](https://flexiple.com/react/react-hooks-cheat-sheet)
- **React_Components** :page_facing_up: [View Flowbite React Components](https://www.flowbite-react.com/) //They also have Forms
- **APIs** :page_facing_up: [List of Useful APIS](https://publicapis.dev/)
